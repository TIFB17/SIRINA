                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
            include "koneksi.php";
            $sql = mysql_query("SELECT * FROM tabel_transaksi");
            
			while ($tampil = mysql_fetch_array($sql)){
			?> 
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><div align="center"><?php echo $tampil['id_transaksi']; ?></div></td>
                                      <td><div align="center"><?php echo $tampil['nama_admin']; ?></td>
                                      <td><div align="center"><?php echo $tampil['nama_pasien']; ?></td>
                                      <td><div align="center"><?php echo $tampil['no_asuransi']; ?></td>
                                      <td><div align="center"><?php echo $tampil['no_kamar']; ?></td>
                                      <td><div align="center"><?php echo $tampil['tanggal_masuk']; ?></td>
                                      <td><div align="center"><?php echo $tampil['tanggal_keluar']; ?></td>
                                      <td><div align="center"><?php echo $tampil['biaya']; ?></td>
                                  </tr>
                                   <?php 
            						}
              							?>
